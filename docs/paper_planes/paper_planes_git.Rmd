...
Improver 1 should make an improvement (e.g., adding turned up ends to the wings).  Then they should put a copy into the repository following the steps above. 
...
**Repository manager** and **metadata manager** prepare a new copy of v3 and pass it to **Originator**.
