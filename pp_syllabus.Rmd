...
skills_topics <- tribble(
  ...
  "Rewinding Git and additional exercises", "[More Git exercises](docs/additional_git_exercises.html): git revert, rebase, cherry-pick",
  # "Reserved class", "none"
...
no_meetings <- tribble(
 ...
 #  "2019-10-22", "2019-10-23", "No meeting: Professor travel",
   "2021-03-15", "2021-03-20", "No meeting: Spring Break",
) %>%
  mutate(days_list = map2(period_start, period_end, expand_days)) %>%
  select(class_name, days_list) %>%
  unnest()

first_class_day = parse_datetime("2021-01-21")

last_class_day = parse_datetime("2021-05-07")
