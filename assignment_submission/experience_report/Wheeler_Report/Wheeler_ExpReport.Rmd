...
The `position_dodge` function allows overlapping objects to be moved side-to-side (Wickham et al., 2019). To connect the dots, `position_nudge` perfectly to move both sides of the line, but it still allowed the lines to overlap.
